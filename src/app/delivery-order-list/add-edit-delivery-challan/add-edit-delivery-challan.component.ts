...
@Component({
  selector: 'app-add-edit-delivery-challan',
  templateUrl: './add-edit-delivery-challan.component.html',
  styleUrls: ['./add-edit-delivery-challan.component.css']
})
export class AddEditDeliveryChallanComponent implements OnInit {
  ...
  submitForm() {
    ...
    if (!this.VehicleWiseForm.valid) {
      ...
      const payload = {
        screenTag: "wm",
        DeliveryChallanId: this.viewDCValues.DeliveryChallanId ? this.viewDCValues.DeliveryChallanId: null,
        saleOrderId: this.viewDCValues.saleOrderId ? this.viewDCValues.saleOrderId: null,
        releaseOrderId: this.viewDCValues.releaseOrderId ? this.viewDCValues.releaseOrderId: null,
        buyerId: this.viewDCValues.buyerId ? this.viewDCValues.buyerId: null,
        buyerName: this.viewDCValues.buyerName ? this.viewDCValues.buyerName: null,
      ...
      const rstSlipObject: any = {
        deliveryChallanId: this.viewDCValues.DeliveryChallanId,
  ...
  submitFormBagWise() {
    ...
    if (!this.BagWisePageOneForm.valid) {
      ...
      const payload = {
        screenTag: "bd",
        DeliveryChallanId: this.viewDCValues.DeliveryChallanId,
        saleOrderId: this.viewDCValues.saleOrderId,
        releaseOrderId: this.viewDCValues.releaseOrderId,
        buyerId: this.viewDCValues.buyerId,
        buyerName: this.viewDCValues.buyerName,
        ...
        dcBagDetailsDto: {
          ...
          remarks: this.viewDCValues.dcBagDetailsDto.remarks
        }
      }
      console.log(payload);
      this.apiService.saveDeliveryChallan(payload).subscribe(async (result: any) => {
